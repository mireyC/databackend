...
type CreateDataSourceByGetLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewCreateDataSourceByGetLogic(ctx context.Context, svcCtx *svc.ServiceContext) *CreateDataSourceByGetLogic {
	return &CreateDataSourceByGetLogic{
...
func (l *CreateDataSourceByGetLogic) CreateDataSourceByGet(req *types.CreateDataSourceReqGet) (*types.ErrorResponse, error) {
