...
type DelDataSourceByGetLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewDelDataSourceByGetLogic(ctx context.Context, svcCtx *svc.ServiceContext) *DelDataSourceByGetLogic {
	return &DelDataSourceByGetLogic{
...
func (l *DelDataSourceByGetLogic) DelDataSourceByGet(req *types.DelDataSourceReqGet) (*types.ErrorResponse, error) {
