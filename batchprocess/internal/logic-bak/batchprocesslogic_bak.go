...
//func (l *BatchProcessLogic) BatchProcess(req *types.BatchProcessReq) (*types.ErrorResponse, error) {
//
...
//	exeitsLines := make([]types.Line, 300)
//
//	// 处理已经存在的中心线
//	dealAlreadyExitsLines(exeitsLines, hadLaneLink)
//
//	markLines := make([]types.Line, 0, 300)
...
//		str = fmt.Sprintf("Batch processing Save All Data to Database completed, total process center_line count: %d, total time costs %v", len(centerLins), saveTotalTime)
//		infoLogger.Println(str)
//
//		totalTime := time.Since(startTime)
//		str = fmt.Sprintf("Batch processing Task completed, total process had_lane_mark_line count: %d, total time costs %v", len(markLines), totalTime)
//		infoLogger.Println(str)
...
//	//muIsGenarated.Lock()
//
//	//muIsGenarated.Unlock()
//	//infoLogger.Println("indexA: ", lineA.Index)
//	//infoLogger.Println("indexB: ", lineB.Index)
//	return l
//}
//
//// dealAlreadyExitsLines
//// 处理已经存在在中心线 转为 []Line
//func dealAlreadyExitsLines(lines []types.Line, geoJson types.HadLaneLink) {
